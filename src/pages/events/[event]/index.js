...
import { Button, Heading, Text, Grid } from "@codeday/topo/Atom";
...
export default function Event({ event }) {
  ...
  return (
    <Page title={event.name}>
      ...
      <Heading>
        {event.name} ({event.displayDate})<UpdateEventModal event={event} />
        ...
        <SponsorOverview
          ...
          buttons={
            <>
              ...
              &nbsp;
              <CreateSponsorModal event={event}>
                <Icon.UiAdd />
              </CreateSponsorModal>
            </>
          }
        ...
        <ScheduleBox
          ...
          buttons={
            <>
              ...
              &nbsp;
              <CreateScheduleItemModal event={event}>
                <Icon.UiAdd />
              </CreateScheduleItemModal>
            </>
          }
        />
        <Notes
