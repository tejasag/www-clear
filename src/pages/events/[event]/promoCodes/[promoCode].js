...
} from '../../../../components/forms/PromoCode';
    ...
    return (
        <Page title="Promo Code">
            ...
            <Heading>
                ...
                <UpdatePromoCodeModal promocode={code} />{' '}
                <DeletePromoCodeModal promocode={code} />
            </Heading>
            <ResponsiveMasonry>
                <Masonry>
                    ...
                    <Notes
                        notes={code.notes}
                        updateId={code.id}
                        updateMutation={SetPromoCodeNotesMutation}
                    />
                </Masonry>
            </ResponsiveMasonry>
...
export async function getServerSideProps({
    ...
    const codeResults = await fetch(GetPromoCodeQuery, {
        data: { id: codeId },
    });
