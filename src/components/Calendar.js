...
export default function Calendar({ event, border, children, ...props }) {
    const schedule = event.schedule.sort((a, b) =>
                        ...
                        {date.format('YYYY-MM-DD') in eventsByDay
                            ? eventsByDay[date.format('YYYY-MM-DD')]
                                  ...
                                  .map((e) => {
                                      ...
                                      const baseColor =
                                          eventColors[e.type || 'Event'] ||
                                          colorHues[
                                              seed(
                                                  e.type.toLowerCase()
                                              ).intBetween(0, colorHues.length)
                                          ];
                                      return (
                                          <Box
                                              as="a"
